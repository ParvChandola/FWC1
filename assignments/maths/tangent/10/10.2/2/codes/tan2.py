...
c = np.array([0,0])
theta_1 = 0
theta_2 = (11*math.pi)/18


#calculations
Q = c+r*np.array([math.cos(theta_1),math.sin(theta_1)])
P = c+r*np.array([math.cos(theta_2),math.sin(theta_2)])
n1 = P-c
n2 = Q-c
A = np.array([n1,n2])
b = np.array([1,1])
m1 = np.array([math.sin(theta_2),-math.cos(theta_2)])
m2 = np.array([math.sin(theta_1),math.cos(theta_1)])
